...
\textbf{Projects  \& Coursework} & \horizontalLine \\
    ...
    {Developed a naturally extensible, custom instruction set architecture and the corresponding assembler, compiler, and simulator.}
    {C, C++, Flex, Bison, LLVM}

	\timeFrame{2015}{2016}{Ten Weeks} &
    \entry{Compiler Construction}{}{}
          {Developed a Java compiler.}
          {Java, ANTLR, LLVM}
    ...
    \entry{DSP System Design}{}{}
          {Study of finite word length effects in DSP systems. Implemented SSB communication system.}
          {MATLAB, LabVIEW}
    ...
    \timeFrame{2014}{2016}{Thirty Weeks} &
...
from Stanford University.}
    ...
    \entry{Data Structures and Algorithm Analysis}{}{}
     ...
     \entry{Embedded System Design}{}{}
              {Developed digital systems using PIC micro-controllers. Interfaced with both digital and analog peripheral devices. Studied PCB layout and design.}
...
\textbf{Education} & \horizontalLine \\
    ...
    \entry{Rose-Hulman Institute of Technology %(3.94 GPA)
    	   }{}{Terre Haute, Indiana}
    ...
    \entry{Rose-Hulman Institute of Technology %(3.64 GPA)
    	   }{}{Terre Haute, Indiana}
